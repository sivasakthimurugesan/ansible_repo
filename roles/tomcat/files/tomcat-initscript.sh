...
# Default-Stop:      0 1 6
# Short-Description: Start Tomcat user instance {{ user_instance.name }}.
# Description:       Start the Tomcat servlet engine for user instance {{ user_instance.name }}.
### END INIT INFO
...
DESC="Tomcat servlet engine for user instance {{ user_instance.name }}"
...
CATALINA_BASE={{ user_instance.parent_directory }}/{{ user_instance.name }}
